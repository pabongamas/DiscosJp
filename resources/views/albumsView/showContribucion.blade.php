@extends('layout')
@section('title', 'Contribuciones albums pendientes')
@section('content')
            ...
            <nav aria-label="breadcrumb " style="    padding-top: 20px;">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item " aria-current="page">
                        <h4 style="padding-right: 10px">Seleccione las contribuciones de albums que desee vincular. </h4>
                    </li>
                    ...
                    <table id="tableContribuciones" class="table table-striped table-hover">
                        <thead class="thead-dark">
                            <tr role="row">
                                ...
                                <th class=" text-center bdright" style="width: 16%;">Nombre album</th>
                                <th class=" text-center bdright" style="width: 16%;">Imagen</th>
                                <th class=" text-center bdright" style="width: 16%;">Artista</th>
                                <th class=" text-center bdright" style="width: 16%;">Genero</th>
                                <th class=" text-center bdright" style="width: 16%;">Contribucion por</th>
                            </tr>
                        </thead>
                        <tbody>
                                    ...
                                    <tr>
                                        <td style="width: 10%" class=" text-center">
                                            ...
                                            <form id="añadir_{{ $contribucion->id }}" class="d-none" method="POST"
                                                action="{{ route('albums.añadirContribucion', $contribucion->id) }}">
                                                @csrf @method('PATCH')
                                        ...
                                        <td style="width: 10%" class="w5 text-center">
                                            ...
                                            <form id="deleteUser_{{ $contribucion->id }}" class="d-none" method="POST"
                                                action="{{ route('albums.eliminarContribucion', $contribucion->id) }}">
                                                @csrf @method('DELETE')
                                        ...
                                        <td style="width: 16%" class=" text-center">
                                            <label>{{ $contribucion->artista }}</label>
                                        </td>
                                        <td style="width: 16%" class=" text-center">
                                            <label>{{ $contribucion->genero }}</label>
                                        </td>
                                        <td style="width: 16%" class=" text-center">
